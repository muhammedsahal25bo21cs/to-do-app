...
const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  event_subtitle_en: 'Annual Cultural & Academic Competitions',
  organizer_name_en: 'Raulathul Madheena Committee',
  description_en: 'Welcome to the official event portal. Event details, schedule, results, and leaderboards will appear as published by administrators.',
  ...
  map_embed_src: 'https://maps.google.com/maps?q=Kerala&t=&z=14&ie=UTF8&iwloc=&output=embed',
  logo_url: '',
  hero_image_url: 'https://images.unsplash.com/photo-1542816417-0983cbe82752?q=80&w=1200&auto=format&fit=crop',
  event_poster_url: '',
  ...
  seo_site_title: 'Milad Fest 2K26 - Official Event Portal',
  seo_meta_description: 'Official competition platform for Milad Fest 2K26 schedule, results, posters, and leaderboards.',
