...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const shareUrl = `${siteUrl}/leaderboard`;

  const title = `Official Leaderboard & Standings — ${eventName}`;
  const description = `View real-time team rankings, points tally, and top performers on ${eventName} Portal.`;
